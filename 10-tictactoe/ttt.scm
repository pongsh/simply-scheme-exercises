...
(tie-game? 'oxoox_xo_)    ;; test if two empty spots will lead to a tie
(tie-game? 'oxooxoxo_)    ;; test if a tie if there are two 'o shapes on a triple and one space
(tie-game? 'oxxoxo_o_)    ;; test if a tie if there are two 'o shapes on a triple and two spaces